							...
							<ul class="nav">
							  <li><a href="media.php?module=home"><i class="fa fa-home"></i> Home</a></li>
                                <li><a href="media.php?module=rekam_medik"><i class="fa fa-medkit"></i> Rekam Medik</a></li>
								 <li><a href="media.php?module=anc"><i class="fa fa-heartbeat"></i> ANC</a></li>
							<?php
                                if($akses=='3'){
                            ?>
                            ...
                            ?>
							  ...
							  <li class="dropdown">
                                ...
                                <li><a href="media.php?module=pegawai"><i class="fa fa-users"></i> Data Pegawai</a></li>
								 ...
								 <li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user-md"></i> Master <b class="caret"></b></a>
								<ul class="dropdown-menu">
								 <li><a href="media.php?module=tindakan">Kategori Tindakan</a></li>
								  <li><a href="media.php?module=diagnosis">Diagnosis</a></li>
								</ul>
							  </li>
