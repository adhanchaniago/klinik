		...
		<div class="row-fluid">
			...
			<div id="hasil"></div>
				...
				<table class="table table-striped">
					<thead>
						<tr class="head">
							<td>No</td><td>Nama Obat</td><td>Jumlah Obat</td><td>Satuan</td><td>Detail</td><td>Expired Date</td><td></td>
						</tr>
					</thead>
					<tbody>
					<?php
					
					$query=mysqli_query($conn,"SELECT * FROM obat ORDER BY nama_obat ASC LIMIT $posisi,$batas");
					$no=$posisi+1;					
					while($r=mysqli_fetch_array($query)){
					?>					
						<tr>
							<td><?php echo $no; ?></td><td><?php echo $r['nama_obat']; ?></td><td><?php echo $r['jmlh_obat']; ?></td><td><?php echo $r['satuan']; ?></td><td><?php echo $r['detail']; ?></td><td><?php echo $r['expired_date']; ?></td><td><div class="btn-group">
					...
					<tr>
							<td colspan="5">
							<?php
							$jmldata=mysqli_num_rows(mysqli_query($conn,"SELECT * FROM obat"));
			...
			<div class="span12 pull-left">
				...
				<div class="span5 offset1">
							...
							<div class="control-group">
							 ...
							 <div class="control-group">
								<label class="control-label" for="inputPassword">Expired Date</label>
								<div class="controls">
								<input type="date"   class="span12" name="t8" id="tanggal">
								</div>
							</div>
...
$query=mysqli_query($conn,"SELECT * FROM obat WHERE id_obat='$kodeobat'");
			...
			<div class="span12 pull-left">
				...
				<div class="span5 offset1">
							...
							<div class="control-group">
								<label class="control-label" for="inputPassword">Expired Date</label>
								<div class="controls">
								<input type="date"   class="span12" name="t8" id="tanggal" value="<?php echo $r['expired_date'] ?>">
								</div>
							</div>
