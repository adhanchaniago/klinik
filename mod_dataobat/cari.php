...
<table class="table table-striped">
					...
					$query=mysqli_query($conn,"SELECT * FROM obat WHERE nama_obat LIKE '%".$kodepasien."%'");
					$no=1;					
					...
					?>					
						<tr>
                            ...
                            $id_obt=$r['id_obat'];
                            $cekobt=mysqli_query($conn,"SELECT * FROM tmp_obat WHERE kdobat='$id_obt'");
                            $ro=mysqli_fetch_array($cekobt);
