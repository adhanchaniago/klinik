	...
	<section>
		<div class="row-fluid">
			...
			<div class="span10 thumb pull-right">
				<?php
				if(isset($kode)){
				$querm=mysqli_query($conn,"SELECT * FROM rekammedik");
			...
			<div class="tab-content" style="padding-bottom: 9px; border-bottom: 1px solid #ddd;">
					<?php
						...
						<div class="control-group">
						<?php
						$qkel=mysqli_query($conn,"SELECT * FROM rekammedik WHERE nomorRm='$koderm'");
...
<div id="hasils" class="pull-left span8"></div>			
					...
					<div class="tab-pane active" id="tab1">
						...
						<table class="table table-bordered table-striped">
						<caption> Data Rekam Medik </caption>
						<thead>
						<tr>
							<th>#</th>
							<th align="center">Nomor RM</th>
							...
							<th align="center">Diagnosa Lainnya</th>
						...
						<tbody>
						<?php
						$qrm=mysqli_query($conn,"SELECT * FROM rekammedik, dokter WHERE rekammedik.kodepasien='$kode' AND dokter.kodeDokter=rekammedik.kodedokter ORDER BY rekammedik.id_rm DESC");
						$no=1;
						...
						<tr>
							...
							<td><?php echo $rrm['pemeriksaan_fisik']; ?></td>
							<td><?php 
							...
							<td>
                                <?php
                                $qil=mysqli_query($conn,"SELECT * FROM tmp_obat, rekammedik WHERE rekammedik.nomorRm=tmp_obat.kdrm");
							...
							<td> <button class="btn btn-danger" onclick="window.location='mod_rm/aksi_rm.php?module=hapus_rm&&id_rm=<?php echo $rrm['id_rm']; ?>&&kode=<?php echo $kode; ?>&&status=pasien'"><i class="icon-trash icon-white"></i></button></td>
						...
						<form method="post" action="<?php echo $aksi."?module=tambahrm" ?>">
							<div class="span6">
								...
								<div class="control-group">
									<label class="control-label" for="inputEmail">Pemeriksaan Fisik :</label>
									<div class="controls">
									<textarea class="span8" name="t10"></textarea>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="inputEmail">Petugas Medis Yang Menangani</label>
