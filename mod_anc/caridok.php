...
echo $kode=$_POST['q'];
$query=mysqli_query($conn,"SELECT * FROM dokter, jadwal_dok, tarif_dok WHERE dokter.kodeDokter='$kode' AND dokter.kodeDokter=jadwal_dok.kodedokter AND dokter.kodedokter=tarif_dok.kodedokter");
