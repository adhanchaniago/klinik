		...
		<div class="row-fluid">
			...
			<div id="hasil"></div>
				...
				<table class="table table-striped">
					<thead>
						<tr class="head1">
							<td>No</td><td>Kode Pasien</td><td>NIK</td><td>Nama Pasien</td><td>Unit</td><td>Jenis Kelamin</td><td>Tanggal Lahir</td><td>Usia</td><td>Tanggal Daftar</td><td></td>
						</tr>
					</thead>
					<tbody>
					<?php					
					$query=mysqli_query($conn,"SELECT * FROM pasien, pegawai WHERE pasien.id_pegawai=pegawai.id_pegawai ORDER BY pegawai.nama_pegawai ASC LIMIT $posisi,$batas");
					$no=$posisi+1;
					...
					<tr>
							<td colspan="9">
							<?php
							$jmldata=mysqli_num_rows(mysqli_query($conn,"SELECT * FROM pasien"));
	...
	?>
		...
		<div class="row-fluid">
			<div class="span12 pull-left">
				...
				<fieldset>
				<legend class="span7 offset1">Tambah Pasien 
				<input type="text" class="span4" id="pegawai" name="t4" required>
